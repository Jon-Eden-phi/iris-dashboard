...
const INITIAL_USERS: IrisUser[] = [
  ...
  { id: 'u12', email: 'ic@simplyphi.co.uk',        name: 'IC Member',      role: 'Investment Committee', isAdmin: false, password: 'ic2024', organisation: 'SimplyPhi', projects: ['proj-bristol-p3'] },
];
